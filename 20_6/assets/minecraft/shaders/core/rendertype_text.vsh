...
void main() {
    ...
    vec3 pos = Position;
    if (ColorValue.r == 24.0 && depthLevel == 2400.12) {
        // title
        if (ColorValue.g == 24.0) {
            pos.y -= 100.0;
        }
        vertexColor = white * texelFetch(Sampler2, UV2 / 16, 0);
    } else if (ColorValue.r == 24.0 && depthLevel == 2400.06) {
        // subtitle
        if (ColorValue.g == 24.0) {
            pos.y -= 2.0;
        }
        pos.z += 0.1;
        vertexColor = white * texelFetch(Sampler2, UV2 / 16, 0);
    } else if (ColorValue.r == 24.0 && depthLevel == 2200.03) {
        // actionbar
        if (ColorValue.g == 24.0) {
            pos.y -= 200.0;
        ...
        pos.z += 300.0;
        vertexColor = white * texelFetch(Sampler2, UV2 / 16, 0);
    } else if (ColorValue.r == 25.0 && depthLevel == 2200.03) {
        pos.y += 40.0;
        pos.z += 300.0;
        ...
        vertexColor = white * texelFetch(Sampler2, UV2 / 16, 0);
    } else if (ColorValue.r == 26.0 && depthLevel == 2200.03) {
        pos.y += 40.0;
        pos.z += 300.0;
